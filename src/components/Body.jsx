...
export const Body = () => {
  ...
  return (
    <Grid span={12} my={{ base: 10, md: 20 }} px={{ md: 18 }} gutter={40} grow>
      <Grid.Col Grid span={{ base: 12, md: 7.8, xs: 9 }}>
        ...
        <Grid mt={30}>
          <Grid.Col span={{ base: 12, md: 6, xs: 9 }}>
            <Title c="hsl(240, 100%, 5%)" className="md:text-[56px] xs:text-5xl">
              The Bright Future of Web 3.0?
            </Title>
          </Grid.Col>
          <Grid.Col span={{ base: 12, md: 6, xs: 10 }}>
            <Text size="sm" fw={500} className="leading-7 tracking-wider">
            ...
            <button className="tracking-[4px] w-[186px] h-10 mt-6 bg-[#F15E50] text-[#00001A] font-extrabold hover:text-[white] hover:bg-[#00001A] text-xs">
              READ MORE
            </button>
          </Grid.Col>
        </Grid>
      ...
      <Grid.Col span={3.5} bg="hsl(240, 100%, 5%)" mx={{ base: 17, md: 2 }} px={20} mt={20} mb={35}>
        ...
        {textContent.map((item, index) => (
          <Box key={index}>
            ...
            <Text fw={400} mx={3} size="sm" c="#87879c" mb={28} className="leading-6 ">
              {item.body}
            </Text>
